...
// --- Runde 1: vælg det bedst mulige starthold for 50.000.000 kr ---
const round1 = optimizeSquad(players, 0, p => p.startpris, BUDGET);
let squad = round1.selected.slice();
let cash = (BUDGET - round1.spent) * 1.01; // bankrente efter rundens transaktioner
...
// --- Runde 2..N: vurder skift ud fra hvad vi nu ved om rundens vækst ---
